...
$r1 = Http 'POST' 'https://127.0.0.1:3000/oa-com/word' '{"action":"get_text"}'
...
$r2 = Http 'POST' 'https://127.0.0.1:3000/oa-com/word' '{"action":"get_text"}'
...
$req3 = [System.Net.HttpWebRequest]::Create('https://127.0.0.1:3000/oa-com/word')
